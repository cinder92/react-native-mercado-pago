...
class RNMercadoPagoActivity implements ActivityEventListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (currentPromise == null || requestCode != MercadoPagoCheckout.EXTRA_PAYMENT_RESULT) {
            return;
        }
